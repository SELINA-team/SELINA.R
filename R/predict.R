...
#'
#' @examples
query_predict <- function(query_expr, model, path_out, outprefix, disease=FALSE, mode="single", seurat, cell_cutoff=5, prob_cutoff=0.9) {
  print("Loading data")
  ...
  predict_downstream(mode, seurat, cell_cutoff, prob_cutoff, path_out,
                                 outprefix)
...
predict_downstream <- function(mode, seurat, cell_cutoff, prob_cutoff, path_out,
                               outprefix){
  #load data
